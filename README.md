...
## How to Cite
@misc{Gatto2021, author = {Gatto, E. C.}, title = {Generate Random Partitions Version 2 for Multilabel Classification}, year = {2021}, publisher = {GitHub}, journal = {GitHub repository}, howpublished = {\url{https://github.com/cissagatto/Generate-Partitions-Random2}}}

## Types of Random Partitions
<img src="https://github.com/cissagatto/Generate-Partitions-Random2/blob/main/images/tipos_particoes_aleatorias_transparente.png" width="300">

## Random Partitions Version 2 with Macro-F1
<img src="https://github.com/cissagatto/Generate-Partitions-Random2/blob/main/images/R2-Ma-Branco.png" width="100">

## Random Partitions Version 2 with Micro-F1
<img src="https://github.com/cissagatto/Generate-Partitions-Random2/blob/main/images/R2-Mi-Branco.png" width="100">

## Random Partitions Version 2 with Silhouete
<img src="https://github.com/cissagatto/Generate-Partitions-Random2/blob/main/images/R2-S-Branco.png" width="100">
...
<img src="https://github.com/cissagatto/Generate-Partitions-Random2/blob/main/images/10-Folds-Cross-Validation.png" width="300">

### Step-2
Place a copy of this code in _"C:/Users/[username]/Generate-Partitions-Random2"_ or _"/home/username/Generate-Partitions-Random2. Our files are configured to obtain the paths of the folders from the root. You can change this in the code if you want.
...
<img src="https://github.com/cissagatto/Generate-Partitions-Random2/blob/main/images/Folder-Structure-R2.png" width="300">
...
<img src="https://github.com/cissagatto/Generate-Partitions-Random2/blob/main/images/OutPut-R2.png" width="300">

## RUN
To run the code, open the terminal, enter */home/[username]/Generate-Partitions-Jaccard/scripts/* folder, and type:

```
Rscript random2.R [number_dataset] [number_cores] [number_folds] [name_folder_results]
```
...
```
Rscript random2.R 17 5 10 "/dev/shm/results/"
```
