...
### Step-2
Place a copy of this code in _"C:/Users/[username]/Generate-Partitions-Random2"_ or _"/home/username/Generate-Partitions-Random2_. Our files are configured to obtain the paths of the folders from the root. You can change this in the code if you want.
...
```
Rscript random2.R 17 5 10 /dev/shm/results/flags
```
