cat("\n\n################################################################################################")
cat("\n# START RANDOM PARTITIONS VERSION 2                                                              #")
cat("\n##################################################################################################\n\n") 
...
timeFinal <- system.time(results <- executeGPR2(number_dataset, number_cores, number_folds, folderResults))
print(timeFinal)
...
##################################################################################################
cat("\nSave Rds\n")
str0 <- paste(diretorios$folderOutputDataset, "/", dataset_name, "-random2-results.rds", sep="")
...
##################################################################################################
cat("\nSave Rdata \n")
str1 <- paste(diretorios$folderOutputDataset, "/", dataset_name, "-random2-results.RData", sep="")
