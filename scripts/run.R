...
##################################################################################################
executeGPR2 <- function(number_dataset, number_cores, number_folds, folderResults){
  ...
  timeGPR2 = system.time(resGPR2 <- generateR2(namesLabels, number_folds, dataset_name, ds, folderResults))
  cat("\n##################################################################################################\n\n") 
  ...
  write.csv(timesExecute, paste(dataset_name, "-RunTime-GPR2.csv", sep=""))
  cat("\n##################################################################################################\n\n")
