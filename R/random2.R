...
#config_file = "/home/cissa/Generate-Partitions-Random2/R2-Config-Files/R2-GpositiveGO.csv"
...
cat("\n####################################################################")
cat("\n# Execute RANDOM 2 Partitions                                      #")
cat("\n####################################################################\n\n")
timeFinal <- system.time(results <- executeGPR2(ds,
                                               dataset_name,
                                               number_dataset, 
                                               number_cores, 
                                               number_folds, 
...
cat("\n####################################################################\n\n")
destino = paste("nuvem:Partitions-Random2/", dataset_name, sep="")
...
str_a <- paste("tar -zcf ", diretorios$folderResults, "/", dataset_name, 
               "-results-gpr2.tar.gz ",  diretorios$folderReports, sep = "")
print(system(str_a))
...
str_b <- paste("cp -r ", diretorios$folderResults, "/", dataset_name, 
               "-results-gpr2.tar.gz ", folder, sep = "")
print(system(str_b))
